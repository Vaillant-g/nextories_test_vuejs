  ...
  <b-container sm>
    <div class="calculatrice">
      ...
      <b-row>
        ...
        <b-col class="volume">
          <p>
            Le volume du meuble est de
            <span class="important"> {{ volume_meuble }} </span> m3
          </p>
  ...
  methods: {
    ajout_meuble: function() {
      if (
        ...
        if (
          this.longueur_meuble == 0 ||
          this.largeur_meuble == 0 ||
          this.hauteur_meuble == 0
        ) {
          alert(
            "La longueur, largeur, et hauteur d'un meuble ne peut pas être égale à 0."
          );
        } else {
